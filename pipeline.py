...
PROJECT_DIR = Path('/home/william')
DEPTH_DIR = Path('/home/william/Depth-Anything-V2')

# Test image (from Depth Anything assets)
img_path = Path('/home/william/data/stanford/area_1/pano/rgb/') 

import os
img_path = Path('/home/william/data/stanford/area_1/pano/rgb/') / os.listdir('/home/william/data/stanford/area_1/pano/rgb/')[0]
